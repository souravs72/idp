...
:mod:`idp.idp.llm.model_registry` and are looked up per-model rather
...
class ModelCapabilities:
	...
	Populated from :mod:`idp.idp.llm.model_registry`, which ships baseline
...
class LLMProvider(ABC):
	...
	:func:`idp.idp.llm.providers.registry.register_provider`.  The
