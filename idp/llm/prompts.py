...
_CHAT_SYSTEM_TEMPLATE = (
	...
	"6. NEVER call create_master autonomously. When masters (Supplier, "
	"Customer, Item, UOM, Account) are missing or extracted items/taxes "
	...
	"Only call list_missing_masters when you need to inspect what is "
	...
	"spans multiple pages, call read_attachment_more to page through the full "
	"text and aggregate items from every page before proposing.  If after a "
	"genuine attempt no items can be located, call ask_user rather than "
