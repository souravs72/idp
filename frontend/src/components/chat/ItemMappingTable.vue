		...
		<table class="w-full border-collapse text-xs">
			<thead>
				...
				<tr>
					...
					<th
						class="border border-gray-400 bg-blue-50 px-2 py-1 text-center font-medium text-gray-700 dark:border-gray-600 dark:bg-blue-950 dark:text-gray-200"
					>
						Stock?
					</th>
					<th
