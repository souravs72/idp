...
<!--
  ...
  | Account | Rate | Tax Amount     | Match | Score    |        |
  ...
  <div class="overflow-x-auto rounded border border-gray-400 dark:border-gray-600">
    <table class="w-full border-collapse text-xs">
      <thead>
        ...
        <tr>
          <th class="border border-gray-400 bg-blue-50 px-2 py-1 text-left font-medium text-gray-700 dark:border-gray-600 dark:bg-blue-950 dark:text-gray-200">Account</th>
          ...
          <th class="border border-gray-400 bg-blue-50 px-2 py-1 text-right font-medium text-gray-700 dark:border-gray-600 dark:bg-blue-950 dark:text-gray-200">
            Tax Amount
          </th>
          ...
          <th class="border border-gray-400 bg-green-50 px-2 py-1 text-right font-medium text-gray-700 dark:border-gray-600 dark:bg-green-950 dark:text-gray-200">
            Score
          </th>
        </tr>
      </thead>
      <tbody>
        ...
        >
          ...
          <td class="border border-gray-300 px-2 py-1 dark:border-gray-700">
            <div class="flex items-center gap-1" :ref="(el) => setAnchor(row.row_index, el)">
              <input
                ...
                :placeholder="row.erpnext_account || row?.extracted?.account || 'Search Account…'"
                :disabled="!editing"
